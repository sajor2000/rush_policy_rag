...
**Test Dataset**: `apps/backend/data/test_dataset_v4.json` (100 realistic staff questions)
...
│   │   │   ├── services/           # ChatService, CohereRerank, SynonymService
...
| `cohere_rerank_service.py` | Cross-encoder reranking |
| `context_expander.py` | Sibling chunk retrieval |
...
See `.env.example` for complete list including context expansion, email, and optional settings.
